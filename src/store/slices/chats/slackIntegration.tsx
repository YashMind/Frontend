...
const slackSlice = createSlice({
    ...
    extraReducers: (builder) => {
        builder
            ...
            .addCase(getSlackCredentials.rejected, (state, action) => {
                state.loading = false;
                state.error = action.payload;
            })
            ...
            .addCase(updateSlackCredentials.rejected, (state, action) => {
                state.loading = false;
                state.error = action.payload;
            })
            ...
            .addCase(deleteSlackInstallation.rejected, (state, action) => {
                state.loading = false;
                state.error = action.payload;
            })

            // Credential verification
            .addCase(verifySlackCredentials.pending, (state) => {
                state.verification.status = 'loading';
                state.verification.error = null;
            })
            .addCase(verifySlackCredentials.fulfilled, (state, action) => {
                state.verification.status = 'succeeded';
                state.verification.data = action.payload;
            })
            .addCase(verifySlackCredentials.rejected, (state, action) => {
