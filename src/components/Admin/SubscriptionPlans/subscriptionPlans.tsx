              ...
              <table className="min-w-full overflow-hidden text-sm">
                ...
                <tbody className="text-white">
                  <tr className="bg-[#0A1330] hover:bg-[#1A2C56]">
                    ...
                    <td className="p-4 text-[#AEB9E1] text-xs">$ 0000</td>
                    ...
                    <td className="p-4 relative">
                      <div className="flex gap-2 items-center">
                        ...
                        <div className="relative inline-block  text-left">
                          ...
                          <div className="absolute right-0 z-10 mt-2 w-56 origin-top-right rounded-md h-84 bg-white shadow-lg ring-1 ring-black ring-opacity-5 peer-checked:block hidden">
                            <div className="py-1">
                              <a
                                href="#"
                  ...
                  <tr className=" hover:bg-[#1A2C56]">
                    ...
                    <td className="p-4 flex items-center text-xs gap-2">pro</td>
                    <td className="p-4 text-[#AEB9E1] text-xs">$ 0000</td>
                    <td className="p-4 text-[#AEB9E1] text-xs">12</td>
                    <td className="p-4 text-[#AEB9E1] text-xs">01-2-2024</td>
                    <td className="p-4 text-[#AEB9E1] text-xs">350</td>
                    <td className="p-4 relative">
                      <div className="flex gap-2 items-center">
                        <button className="text-gray-300 hover:text-white">
                          <svg
                  ...
                  <tr className="bg-[#0A1330] hover:bg-[#1A2C56]">
                    ...
                    <td className="p-4 text-[#AEB9E1] text-xs">12</td>
                    <td className="p-4 text-[#AEB9E1] text-xs">01-2-2024</td>
                    <td className="p-4 text-[#AEB9E1] text-xs">200</td>
                    <td className="p-4 relative">
                      <div className="flex gap-2 items-center">
                        <button className="text-gray-300 hover:text-white">
                          <svg
