      ...
      <div className=" Testimonials mt-[110px]">
        <div className="container">
          ...
          <div className="slide container">
            <section className="py-[55px]  custom-gradient-bg">
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 h-[490px] items-center w-[1200px] mx-auto">
                {/* Testimonial Card 1 */}
                <div
                ...
                >
                  ...
                  <p className="text-gray-100 italic text-center text-[16px] w-[80%] mx-auto">
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                    Cursus nibh mauris, nec turpis orci lectus maecenas.
                    Suspendisse sed magna eget nibh in turpis. Consequat duis
                    diam lacus arcu. Faucibus venenatis felis id augue sit
