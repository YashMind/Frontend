          ...
          <div className="mx-auto max-w-6xl grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="bg-[#1B1441] rounded-tr-[18px] rounded-bl-[18px] border border-[#FFFFFF33] p-6 text-white flex flex-col justify-between">
              <div>
                ...
                <ul className="space-y-2 text-sm">
                  <li className="flex gap-2"><img src="/images/star.png" /> 2 Chatbots</li>
                  <li className="flex gap-2"><img src="/images/star.png" /> Rs. 1 per 1000 tokens</li>
                  <li className="flex gap-2"><img src="/images/star.png" /> 10 Million Characters</li>
                  <li className="flex gap-2"><img src="/images/star.png" /> Crawl 2000 Website Pages</li>
                  <li className="flex gap-2"><img src="/images/star.png" /> 5 Team Members</li>
                </ul>
              </div>
              <div className="mt-6">
            ...
            <div className="p-[2.31px] rounded-tr-[18px] rounded-bl-[18px] bg-gradient-to-r from-[#4E2295] to-[#42579D] h-full">
              <div className="bg-[#1B1441] rounded-tr-[16px] rounded-bl-[16px] backdrop-blur-[32.8px] shadow px-5 py-8 text-white flex flex-col justify-between h-full">
                <div>
                  ...
                  <ul className="space-y-2 text-sm">
                    <li className="flex gap-2"><img src="/images/star.png" /> 10 Chatbots</li>
                    <li className="flex gap-2"><img src="/images/star.png" /> Rs. 1 per 1500 tokens</li>
                    <li className="flex gap-2"><img src="/images/star.png" /> 20 Million Characters</li>
                    <li className="flex gap-2"><img src="/images/star.png" /> Crawl 10,000 Website Pages</li>
                    <li className="flex gap-2"><img src="/images/star.png" /> 10 Team Members</li>
                  </ul>
                </div>
                <div className="mt-6">
            ...
            <div className="bg-[#1B1441] rounded-tr-[18px] rounded-bl-[18px] border border-[#FFFFFF33] p-6 text-white flex flex-col justify-between">
              <div>
                ...
                <ul className="space-y-2 text-sm">
                  <li className="flex gap-2"><img src="/images/star.png" /> 30 Chatbots</li>
                  <li className="flex gap-2"><img src="/images/star.png" /> Rs. 1 per 2000 tokens</li>
                  <li className="flex gap-2"><img src="/images/star.png" /> 50 Million Characters</li>
                  <li className="flex gap-2"><img src="/images/star.png" /> Crawl 30,000 Website Pages</li>
                  <li className="flex gap-2"><img src="/images/star.png" /> 30 Team Members</li>
                </ul>
              </div>
              <div className="mt-6">
