...
import { createPaymentOrderCashfree, createPaymentOrderPaypal } from '@/store/slices/payments/slice';
...
const Gateways = ({ plan_id, credit }: { plan_id?: string, credit?: string }) => {
    ...
    const handlePaymentRequest = async () => {
        ...
        try {
            ...
            if (selectedGateway === "cashfree") {
                const res = await dispatch(createPaymentOrderCashfree(payload)).unwrap();
                response = res;
    ...
    const activeGateways = paymentGatewayData?.filter(
            ...
            <div className="max-w-md mx-auto bg-white rounded-xl shadow-md overflow-hidden md:max-w-2xl">
                <div className="p-8">
                    ...
                    <div className="space-y-4">
                        {/* Cashfree Option */}
                        {activeGateways.some(g => g.payment_name === 'Cashfree') && (
                            <div
                        ...
                        {/* PayPal Option */}
                        {activeGateways.some(g => g.payment_name === 'PayPal') && (
                            <div
