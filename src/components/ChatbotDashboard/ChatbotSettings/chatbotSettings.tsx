...
import { deleteChatbot, updateChatbotWithoutRouter } from "@/store/slices/chats/chatSlice";
        ...
        <div className="w-full  py-[50] ">
          ...
          <div className="bg-white rounded-2xl overflow-hidden shadow-md mb-4">
            ...
            <div className="p-4 space-y-4">
              <div className="flex items-center justify-between text-sm font-light text-black">
                ...
                <div className="flex items-center gap-1 text-xs">
                  ...
                  <label className="relative inline-flex items-center cursor-pointer">
                    <input type="checkbox" {...register("public")} className="sr-only peer" />
              ...
              />
              <div>
                <button type="submit" className="bg-green-500 hover:bg-green-600 text-white px-6 py-1.5 text-sm font-bold rounded-[10px]">
                  Save
                </button>
              </div>
            </div>
          ...
          <div className="bg-white rounded-2xl overflow-hidden shadow-md mb-4">
            ...
            <div className="p-4 space-y-4 text-base text-black  font-light">
              ...
              <input
                ...
                className="px-4 py-2 rounded-full bg-[#D9D9D9] text-sm focus:outline-none text-[#727272] placeholder-[#727272]"
              />
             <span className="ml-2 text-sm text-gray-600">Yes, I want to delete this bot and all its data permanently.</span>
              <div>
                <button type="button" 
                ...
                disabled={!deleteChecked} onClick={()=>handleDeleteChatbot()}>
                  Delete
                </button>
              </div>
            </div>
