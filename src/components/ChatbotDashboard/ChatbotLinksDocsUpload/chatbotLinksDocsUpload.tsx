          ...
          <ChatbotSidebar />            
            <div className="w-full">
              ...
              <div className="bg-[#FFFFFF80] p-4 md:p-6 rounded-2xl text-white mt-[25px]  w-full mx-auto">
                ...
                <div className="bg-[#9592ae] p-6 md:p-10 rounded-2xl border-dashed border-2 border-white text-center">
              ...
              {/* <table></table> */}
              <div className="bg-white rounded-b-xl overflow-hidden  text-sm w-full rounded-[40px] mb-8 mr-3 mt-[35px] ">
                {/* Top Actions */}
