...
} from "@/store/slices/chats/slackIntegration";
...
const RegisterSlackPage = ({ botId }: { botId?: number }) => {
  ...
  const [expandedDoc, setExpandedDoc] = useState<any>();
  ...
  useEffect(() => {
    const loadRegistration = async () => {
      try {
        ...
        // Convert botId to string
        const res = await dispatch(
          getSlackCredentials(botId.toString())
        ).unwrap();
  ...
  const saveCredentials = async () => {
    ...
    try {
      if (hasCredentials) {
        await dispatch(
          updateSlackCredentials({
            installation_id: botId!, // Use botId as installation_id
                    ...
                    <div className="ml-4">
                      ...
                      <div className="mt-2 flex items-center text-sm">
                        ...
                        <span className="ml-3 text-gray-500">
                          Connected on:{" "}
                          {!isLoading
                            ? formatDate(installation.installed_at, timezone)
                            : "-"}
                        </span>
                      </div>
                    </div>
                  ...
                  <div className="space-y-6">
                    <div className="bg-gray-50 rounded-lg p-6 text-center">
                      ...
                      <p className="text-gray-600 max-w-md mx-auto mb-6">
                        Authorize our app to access your Slack workspace using
                        your credentials.
                      </p>
                      ...
                      <a
                        ...
                        className={`py-3 px-8 rounded-lg font-medium text-white bg-gradient-to-r from-purple-600 to-purple-700 hover:from-purple-700 hover:to-purple-800 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-purple-500 transition-all shadow-lg flex items-center justify-center mx-auto ${
                  ...
                  <div className="p-4 text-sm text-gray-700 space-y-4">
                    <div className="bg-blue-50 border-l-4 border-blue-400 p-4 rounded">
                      ...
                      <ol className="list-decimal pl-5 space-y-1 text-gray-700">
                        ...
                        <li>
                          Select your preferred format below and copy the
                          manifest
                        </li>
                        <li>
                          Paste into Slack's manifest editor and click "Create"
                        </li>
                      </ol>
                    </div>
  ...
  "settings": {
    ...
    "token_rotation_enabled": false
                    ...
                    <div className="text-xs text-gray-500">
                      <p>
                        <strong>Note:</strong> Make sure to replace placeholder
                        URLs with your actual endpoints if different from the
                        examples.
                      </p>
                    </div>
                  </div>
                      ...
                      <div className="p-4 text-sm text-gray-700 space-y-2">
                        <ol className="list-decimal pl-5 space-y-1">
                          <li>
                            ...
                            <ul className="list-disc pl-5 mt-1">
                              <li>
                                Go to sidebar → <strong>Features</strong>
                              </li>
                              <li>
                                Under Features header →{" "}
                    ...
                    {expandedSection === "permissions" && (
                      <div className="p-4 text-sm text-gray-700 space-y-2">
                        <ol className="list-decimal pl-5 space-y-1">
                          <li>
                            Go to{" "}
                            <strong>Features → OAuth & Permissions</strong>
                          </li>
                          <li>
                            Scroll to <strong>"Scopes"</strong> section
                          </li>
                          <li>
                            Under <strong>"Bot Token Scopes"</strong>, click{" "}
                          ...
                          <li className="pt-2">
                            <strong>Important:</strong> Reinstall the app after
                            adding scopes
                          </li>
                        </ol>
                      </div>
                  ...
                  <div className="border border-gray-200 rounded-lg overflow-hidden">
                    ...
                    {expandedSection === "appHome" && (
                      <div className="p-4 text-sm text-gray-700 space-y-2">
                        <ol className="list-decimal pl-5 space-y-1">
                          <li>
                            Go to <strong>Features → App Home</strong>
                          </li>
                          <li>
                            Under{" "}
                            <strong>"Your App's Presence in Slack"</strong>:
                            <ul className="list-disc pl-5 mt-1">
                          ...
                          <li>
                            Scroll to <strong>"Show Tabs"</strong> section
                          </li>
                          <li>
                            Check this box:
                              ...
                              <div className="flex items-start">
                                ...
                                <div className="ml-3">
                                  <p className="text-sm text-yellow-700">
                                    <strong>
                                      Allow users to send Slash commands and
                  ...
                  <div className="border border-gray-200 rounded-lg overflow-hidden">
                    ...
                    {expandedSection === "slashCommand" && (
                      <div className="p-4 text-sm text-gray-700 space-y-2">
                        <ol className="list-decimal pl-5 space-y-1">
                          <li>
                            Go to <strong>Features → Slash Commands</strong>
                          </li>
                          <li>
                            Click <strong>"Create New Command"</strong>
                          </li>
                          <li>
                            Configure command:
                            <ul className="list-disc pl-5 mt-1">
                              <li>
                                <strong>Command:</strong> <code>/ask</code>
                              </li>
                              <li>
                              ...
                              <li>
                                <strong>Short Description:</strong> Ask
                                questions to the assistant
                              </li>
                              <li>
                                <strong>Usage Hint:</strong> [your_question]
                              </li>
                            </ul>
                          </li>
                          <li>
                          ...
                          <li>
                            <strong>Reinstall the app</strong> for changes to
                            take effect
                          </li>
                        </ol>
                      </div>
                  ...
                  <div className="mt-6 p-4 bg-purple-50 rounded-lg border border-purple-200">
                    ...
                    <ul className="text-sm text-purple-700 space-y-1">
                      <li>
                        ...
                        >
                          <FiHelpCircle className="mr-1" /> Slack API
                          Documentation
                        </a>
                      </li>
                      <li>
                        <a
                          ...
                          className="hover:underline flex items-center"
                        >
                          <FiHelpCircle className="mr-1" /> OAuth Authentication
                          Guide
                        </a>
                      </li>
                      <li>
