    ...
    <div className="w-full">
      ...
      {botPage === "overview" ? (
        <div className="flex gap-10 mb-10 ">
                  ...
                  <div className="flex justify-between mb-2">
                    <div className="flex items-center space-x-2 justify-between w-full">
                      <p className="font-semibold text-base  text-[#000]">
                        Today’s User and Token Consumed
                      </p>
                      <div>
                        <Image
                          alt="alt"
          ...
          {/* right chatbot */}
          <div className="w-[320] bg-white  h-[500px] rounded-lg shadow-lg flex flex-col justify-between ">
            <div className="p-4 flex items-center gap-2 border-b justify-between">
            ...
            <div className="text-[#6B6B6B] text-center text-sm py-5 shadow-2xl">
              <h6 className="text-xs text-gray-300">powered by fastebots</h6>
            </div>
          </div>
        </div>
      ) : null}
