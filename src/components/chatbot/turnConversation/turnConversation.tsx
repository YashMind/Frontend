      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-3 gap-12 items-center">
        ...
        <div className="flex flex-col gap-16">
          ...
          <div>
            ...
            <p className="text-xs text-white font-light mb-4">
              If your chatbot serves users in worldwide, language barriers could
        ...
        <div className="flex flex-col gap-16">
          ...
          <div>
            ...
            <p className="text-xs text-white font-light mb-4">
              Keeping your chatbot up-to-date is crucial when managing a website
              that frequently changes content or receives updates.
            </p>
            <button className="bg-[#0073AA] text-white text-xs px-6 py-2 rounded-[22px] font-bold">
              Try Now
            </button>
