...
const platforms = [
  { name: "Wordpress", image: "/images/website.png" },
  { name: "Joomla", image: "/images/website2.png" },
  { name: "Shopify", image: "/images/website1.png" },
  { name: "GoDaddy", image: "/images/website4.png" },
];
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
          ...
          <div className="text-center lg:text-left">
            ...
            <p className="text-base text-[#686868] mt-4 font-bold lg:w-[439px] w-full">
              Install our Chatbots on any Website platform by adding one line of code
            </p>
          </div>
            ...
            {platforms.map((platform, idx) => (
              ...
              >
                <Image
                  ...
                  height={58}
                  width={58}
                  className="absolute top-[-33px] left-1/2 transform -translate-x-1/2"
                />
