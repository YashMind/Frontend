"use client"
import { deleteAllBotsChats, getChatbots } from '@/store/slices/chats/chatSlice';
    ...
    return (
        <div className="max-w-3xl mx-auto px-4 py-2">
                ...
                <div className="space-y-6">
                    <div className="flex justify-between items-start">
                        <div className="flex-1">
                            ...
                            <p className="text-gray-500 text-sm mt-1">View and manage your archived chats</p>
                        </div>
                        <button type='button' className="text-gray-400 hover:text-gray-600 p-2 rounded-full hover:bg-gray-100">
                    ...
                    <div className="flex justify-between items-start">
                        <div className="flex-1">
                            ...
                            <p className="text-gray-500 text-sm mt-1">Move all your chats to archive</p>
                        </div>
                        <button type='button' className="text-gray-400 hover:text-gray-600 p-2 rounded-full hover:bg-gray-100">
                            <CheckmarkIcon className="w-5 h-5" />
                        </button>
                    ...
                    <div className="flex justify-between items-start">
                        <div className="flex-1">
                            ...
                            <p className="text-gray-500 text-sm mt-1">Permanently delete all your chats. This action cannot be undone.</p>
                        </div>
                        <button
                            onClick={() => setState(prev => ({ ...prev, showDeleteChats: true }))}
                            type='button'
            ...
            <div className="bg-white rounded-lg shadow-sm p-6">
                <h2 className="text-lg font-semibold text-gray-900 mb-4">Data Control</h2>
                <p className="text-gray-500 text-sm mb-6">You can control all your data here.</p>
            ...
            <ConfirmDeleteModal
                ...
                onClose={() => setState(prev => ({ ...prev, showDeleteChats: false }))}
