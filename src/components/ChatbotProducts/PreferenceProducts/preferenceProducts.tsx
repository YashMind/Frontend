...
const PreferenceProducts = () => {
  ...
  return (
    <div className="Preferences p-6 space-y-6 bg-[#2B255C] ml-2 md:ml-[8px]">
      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        <div className="flex flex-col relative w-full md:w-[422px] mt-6">
          <label
            htmlFor="ai-model"
          ...
          <input
            ...
            className="bg-[#171821] text-white text-sm font-medium placeholder-[#D2D2D2] rounded-md px-4 py-3 w-full outline-none"
          />
        ...
        <div className="flex flex-col gap-2 text-white mt-6">
          ...
          <button
            type="submit"
            className="bg-[#2F0448] px-6 py-2 rounded-[8px] text-white font-medium text-lg w-fit mt-4"
          >
            Save
          </button>
        </div>
