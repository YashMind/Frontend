...
const ResetPasswordForm = () => {
  ...
  const handleResetPassword = async () => {
    ...
    try {
      ...
      setTimeout(() => router.push("/auth/signin"), 3000); // Fixed redirect URL
    } catch (error: any) {
      setResetStatus({
        success: false,
        message:
          error.payload?.detail || error.message || "Failed to reset password",
      });
    } finally {
      setIsLoading(false);
    }
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="flex flex-col lg:flex-row items-center justify-center lg:justify-between gap-8">
          ...
          <div className="w-full max-w-md bg-white/10 backdrop-blur-md rounded-xl p-8 relative z-20">
            ...
            <div className="space-y-4">
              ...
              <div className="relative">
                <input
                  ...
                  type={showPassword ? "text" : "password"}
                  className="w-full bg-[#261046] text-white p-4 pl-12 pr-12 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500"
            ...
            <button
              className={`w-full mt-6 bg-gradient-to-r from-[#501794] to-[#3E70A1] text-white py-3 rounded-lg text-lg font-medium transition ${
